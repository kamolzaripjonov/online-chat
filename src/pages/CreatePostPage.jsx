            ...
            <div
                ...
                <div className="flex-1 overflow-y-auto p-4">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div><p
                            className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{profile?.name || profile?.username}</p>
                    ...
                    {error && <div
                        className="bg-red-500/20 border border-red-500/50 rounded-lg p-3 text-red-400 text-sm mb-4">{error}</div>}
                </div>
                <div
                    ...
                    <label
                        ...
                        <input type="file" multiple accept="image/*,video/*" onChange={handleImageSelect}
                               className="hidden"/>
                    </label>
                    <button onClick={handleShare} disabled={loading || (!caption.trim() && media.length === 0)}
