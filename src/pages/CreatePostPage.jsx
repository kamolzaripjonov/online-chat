...
export default function CreatePostPage({onClose}) {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center">
            <div
                className={`w-full sm:w-[400px] rounded-t-2xl sm:rounded-2xl p-6 max-h-[80vh] overflow-auto ${isDarkMode ? 'bg-slate-800' : 'bg-white'}`}>
                ...
                <div className="space-y-4">
                    ...
                    {!previewUrl ? (
                        ...
                        >
                            ...
                            <p className={`${isDarkMode ? 'text-gray-500' : 'text-gray-400'} text-sm`}>from your
                                gallery</p>
                        </button>
                    ) : (
