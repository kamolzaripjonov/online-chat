        ...
        <div className="fixed inset-0 bg-slate-900 flex flex-col z-50">
            <div className="flex-1 relative flex items-center justify-center">
                ...
                <button onClick={onClose}
                        className="absolute top-5 right-5 p-2 text-white/70 hover:text-white hover:bg-white/10 rounded-full transition">
                    <X className="w-6 h-6"/>
                </button>
                ...
                {status === 'calling' && (
                    <div className="text-center">
                        <div
                            className="w-40 h-40 rounded-full border-8 border-blue-500/20 flex items-center justify-center mx-auto animate-pulse">
