...
export default function BottomNavigation({ activeTab, onTabChange }) {
  ...
  return (
    <nav className={`fixed bottom-0 left-0 right-0 z-40 border-t pb-safe ${isDarkMode ? 'bg-slate-900/95 backdrop-blur-lg border-slate-800' : 'bg-white/95 backdrop-blur-lg border-gray-200'}`}>
